...
{
    class ClaseListaDobleDesordenada<Tipo> where Tipo :
IComparable<Tipo>, IEquatable<Tipo>
    {
        ...
        //Constructor
        public ClaseListaDobleDesordenada()
        {
        ...
        public Tipo Buscar(Tipo Nodo)
        {
            if (!EstaVacia())
            {
                ...
                while (NodoActual != null)
                {
                    ...
                    NodoActual = NodoActual.Siguiente; // Cambia al siguiente nodo
                }
        ...
        public IEnumerable<Tipo> DesdeNodoFinal
        {
            get
            {
                ...
                while (NodoActual != null) // Mientras haya nodos ...
                {
                    yield return
                    (Tipo)NodoActual.ObjetoConDatos; // Devuelve el NodoActual
                    NodoActual = NodoActual.Anterior; // Cambia de NodoActual
                }
            }
        }
    }
