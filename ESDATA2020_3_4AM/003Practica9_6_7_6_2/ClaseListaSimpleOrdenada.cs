...
{
    // Declaración de la clase con sus restricciones
    class ClaseListaSimpleOrdenada<Tipo> where Tipo :
    IComparable<Tipo>, IEquatable<Tipo>
    {
            ...
            do
            {
                if (Nodo.Equals(NodoActual.ObjetoConDatos)) // Verifica si es el Nodo que desea borrar
                {
                    ...
                    if (Nodo.Equals(NodoInicial.ObjetoConDatos)) // ¿Es el primer nodo de la lista ?
                    {
                        ...
                        NodoActual = null; //Se elimina el Nodo Actual
                        return (NodoEliminado.ObjetoConDatos); // Eliminación  exitosa(devuelve los datos del nodo eliminado)
                    }
                    else
                    {
        ...
        // Método para buscar un Nodo en la ListaEnlazada Simple
